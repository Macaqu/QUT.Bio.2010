...
namespace QUT.Bio.BioPatML.Common.Structures {
	...
	public class MapChar : IEnumerator, IEnumerable {
		...
		/// <summary> Constructs a new, empty hashtable with the specified initial capacity and
		...
		/// <summary> Constructs a new, empty hashtable with a default capacity and load factor,
