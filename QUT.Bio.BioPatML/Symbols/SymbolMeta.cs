...
namespace QUT.Bio.BioPatML.Symbols {
	...
	public class SymbolMeta : Symbol {
		/// <summary> A List encapsulating all the symbols within this meta
		/// </summary>

		private List<Symbol> symbolset = null;

		/// <summary> Creates a meta symbol. 
		/// </summary>
		...
		/// <param name="letters">An optional list of characters that are represented by this metasymbol.</param>
		...
		public SymbolMeta ( 
			...
			// TODO: (LB) this looks like a bug -- letters is never used.
		}

		/// <summary> Total number of symbol elements within the symbol set.
		/// </summary   >
		...
		/// <summary> Gets a symbol element at the specified index.
		/// </summary>
		...
		/// <summary> Adds a symbol to the set of symbols described by this meta symbol.
		/// </summary>
		...
		/// <summary> Removes the given symbol from the symbol set.
		/// </summary>
		...
		/// <summary> Replaces the first occurrences of a symbol(symbol1) with a specified replacement symbol (symbol2).
		/// </summary>
		...
		/// <summary> Returns true if the symbol set is empty or if the given symbol is in the
		///  symbol set.
		/// </summary>
